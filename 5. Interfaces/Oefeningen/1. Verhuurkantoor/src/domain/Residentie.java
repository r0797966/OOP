...
public class Residentie {
    ...
    public ArrayList<Verblijf> verblijvenNietBetaaldeBelastingen(){
        ...
        for(Verblijf v: this.verblijven) {
            if(v instanceof heeftGemeenteBelastingBetaald) {
                heeftGemeenteBelastingBetaald s = (heeftGemeenteBelastingBetaald) v;
                if(!((heeftGemeenteBelastingBetaald) v).heeftGemeenteBelastingBetaald()) verblijven.add(v);
            }
        }
        return verblijven;
    }
